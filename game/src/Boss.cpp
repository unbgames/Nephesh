...
void Boss::RollingStoneAttack() {
    ...
    auto *sound = new Sound(associated, ASSETS_PATH("/audio/boss/boss_earthbend.wav") );
    ...
    auto dustSprite = new Sprite(*chargeObj2, ASSETS_PATH("/img/poeira.png"), 6, chargeTime / 6);
