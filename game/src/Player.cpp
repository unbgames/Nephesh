...
Player::Player(GameObject &associated) : Component(associated), speed({0, 0}), state(STARTING), hp(PLAYER_MAX_HP),
    ...
    movingData.emplace_back(RIGHT, ASSETS_PATH("/img/walk_side.png"), Vec2(0.421, 1), Vec2(20, 0));
    movingData.emplace_back(LEFT, ASSETS_PATH("/img/walk_side.png"), Vec2(0.421, 1), Vec2(-15, 0));
    movingData.emplace_back(UP, ASSETS_PATH("/img/walk_up.png"), Vec2(0.353, 1), Vec2(0, 0));
    movingData.emplace_back(DOWN, ASSETS_PATH("/img/walk_down.png"), Vec2(0.353, 1), Vec2(0, 0));
    grassStepSounds.emplace_back( ASSETS_PATH("/audio/steps/grass/grass_1.wav") );
    grassStepSounds.emplace_back( ASSETS_PATH("/audio/steps/grass/grass_2.wav") );
    grassStepSounds.emplace_back( ASSETS_PATH("/audio/steps/grass/grass_3.wav") );
    grassStepSounds.emplace_back( ASSETS_PATH("/audio/steps/grass/grass_4.wav") );
    grassStepSounds.emplace_back( ASSETS_PATH("/audio/steps/grass/grass_5.wav") );
    grassStepSounds.emplace_back( ASSETS_PATH("/audio/steps/grass/grass_6.wav") );
    stoneStepSounds.emplace_back( ASSETS_PATH("/audio/steps/stone/stone_1.wav") );
    stoneStepSounds.emplace_back( ASSETS_PATH("/audio/steps/stone/stone_2.wav") );
    stoneStepSounds.emplace_back( ASSETS_PATH("/audio/steps/stone/stone_3.wav") );
    stoneStepSounds.emplace_back( ASSETS_PATH("/audio/steps/stone/stone_4.wav") );
    stoneStepSounds.emplace_back( ASSETS_PATH("/audio/steps/stone/stone_5.wav") );
    stoneStepSounds.emplace_back( ASSETS_PATH("/audio/steps/stone/stone_6.wav") );
    dirtStepSounds.emplace_back( ASSETS_PATH("/audio/steps/dirt/dirt_1.wav") );
    dirtStepSounds.emplace_back( ASSETS_PATH("/audio/steps/dirt/dirt_2.wav") );
    dirtStepSounds.emplace_back( ASSETS_PATH("/audio/steps/dirt/dirt_3.wav") );
    dirtStepSounds.emplace_back( ASSETS_PATH("/audio/steps/dirt/dirt_4.wav") );
    dirtStepSounds.emplace_back( ASSETS_PATH("/audio/steps/dirt/dirt_5.wav") );
    dirtStepSounds.emplace_back( ASSETS_PATH("/audio/steps/dirt/dirt_6.wav") );


    dashingData.emplace_back(RIGHT, ASSETS_PATH("/img/dash_side.png"), Vec2(0.311, 1.098), Vec2(20, 0));
    dashingData.emplace_back(LEFT, ASSETS_PATH("/img/dash_side.png"), Vec2(0.311, 1.098), Vec2(-15, 0));
    dashingData.emplace_back(UP, ASSETS_PATH("/img/dash_up.png"), Vec2(0.49, 1.018), Vec2(0, 0));
    dashingData.emplace_back(DOWN, ASSETS_PATH("/img/dash_down.png"), Vec2(0.38, 1.018), Vec2(0, 0));
    dashSounds.emplace_back( ASSETS_PATH("/audio/dash/dash_1.wav") );
    dashSounds.emplace_back( ASSETS_PATH("/audio/dash/dash_2.wav") );
    dashSounds.emplace_back( ASSETS_PATH("/audio/dash/dash_3.wav") );

    shootingData.emplace_back(RIGHT, ASSETS_PATH("/img/magic_side.png"), Vec2(0.5, 0.92), Vec2(20, 0), Vec2(65, -40));
    shootingData.emplace_back(LEFT, ASSETS_PATH("/img/magic_side.png"), Vec2(0.5, 0.92), Vec2(-15, 0), Vec2(-60, -40));
    shootingData.emplace_back(UP, ASSETS_PATH("/img/magic_up.png"), Vec2(0.4, 0.92), Vec2(0, 0), Vec2(3, -80));
    shootingData.emplace_back(DOWN, ASSETS_PATH("/img/magic_down.png"), Vec2(0.4, 0.92), Vec2(0, 0), Vec2(4, 10));

    attackingData.emplace_back(RIGHT, ASSETS_PATH("/img/attack_side.png"), Vec2(0.247, 0.933), Vec2(-10, 0), Vec2(60, 0));
    attackingData.emplace_back(LEFT, ASSETS_PATH("/img/attack_side.png"), Vec2(0.247, 0.933), Vec2(10, 0), Vec2(-60, 0));
    attackingData.emplace_back(UP, ASSETS_PATH("/img/attack_up.png"), Vec2(0.342, 0.848), Vec2(0, 0), Vec2(0, -40));
    attackingData.emplace_back(DOWN, ASSETS_PATH("/img/attack_down.png"), Vec2(0.375, 0.965), Vec2(0, 0), Vec2(0, 30));
    attackMissSounds.emplace_back( ASSETS_PATH("/audio/sword/attack_miss_1.wav") );
    attackMissSounds.emplace_back( ASSETS_PATH("/audio/sword/attack_miss_2.wav") );
    attackMissSounds.emplace_back( ASSETS_PATH("/audio/sword/attack_miss_3.wav") );
    attackHitSounds.emplace_back( ASSETS_PATH("/audio/sword/attack_hit_1.wav") );
    attackHitSounds.emplace_back( ASSETS_PATH("/audio/sword/attack_hit_2.wav") );
    attackHitSounds.emplace_back( ASSETS_PATH("/audio/sword/attack_hit_3.wav") );

    idleData.emplace_back(RIGHT, ASSETS_PATH("/img/idle_down.png"), Vec2(0.444, 1), Vec2(25, 0));
    idleData.emplace_back(LEFT, ASSETS_PATH("/img/idle_up.png"), Vec2(0.444, 1), Vec2(25, 0));
    idleData.emplace_back(UP, ASSETS_PATH("/img/idle_up.png"), Vec2(0.444, 1), Vec2(25, 0));
    idleData.emplace_back(DOWN, ASSETS_PATH("/img/idle_down.png"), Vec2(0.444, 1), Vec2(25, 0));
...
void Player::Start() {
    ...
    healthBarObject->AddComponent(new Bar(*healthBarObject, ASSETS_PATH("/img/health_bar.png"), PLAYER_MAX_HP, PLAYER_MAX_HP));
    ...
    chargingBarObject->AddComponent(new Bar(*chargingBarObject, ASSETS_PATH("/img/health_bar.png"), 100, 100));
...
void Player::Shoot() {
    ...
    switch (currentDirection) {
        case RIGHT:
        case LEFT:
            spriteName = ASSETS_PATH("/img/pre_magic_side.png");
            break;
        case UP:
            offset = Vec2(-24, 0);
            spriteName = ASSETS_PATH("/img/pre_magic_up.png");
            break;
        case DOWN:
            offset = Vec2(-17, 0);
            spriteName = ASSETS_PATH("/img/pre_magic_down.png");
            break;
    }
    ...
    PlaySound( ASSETS_PATH("/audio/magic_attack.wav") );
}
...
//    attackObject->box.PlaceCenterAt(playerBoxCenter + GetStateData(attackingData).objectSpriteOffset);
    ...
    switch (currentDirection) {
        case RIGHT:
            ...
            colScale = {1, 2.5};
            colOffset = {0, 20};
            spriteName = ASSETS_PATH("/img/slash_side_v1.png");
            break;
        case LEFT:
            offset += {-(associated.box.w/2 + 30), -20};
            colScale = {1, 2.5};
        ...
        case UP:
            offset += {0, -60};
            colScale = {0.7, 0.6};
            spriteName = ASSETS_PATH("/img/slash_up_v1.png");
            break;
        case DOWN:
            offset += {0, associated.box.h/2 };
            colScale = {0.7, 0.6};
            spriteName = ASSETS_PATH("/img/slash_down_v1.png");
            frameCount = 6;
            break;
    }
...
void Player::UpdateCharge(float dt) {
    if (!charged) {
        ...
        if (currentDuration > PLAYER_CHARGE_DURATION) {
            chargeTimer.Restart();
            PlaySound( ASSETS_PATH("/audio/lazer_ready.wav") );
            chargeCount = 100;
            charged = true;
        } else {
